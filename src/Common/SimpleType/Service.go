...
const TT_S_US_AIR_1DAYAM    = "DM" // UPS Next Day Air Early
const TT_S_US_AIR_1DAY      = "DA" // UPS Next Day Air
const TT_S_US_AIR_SAVER     = "DP" // UPS Next Day Air Saver
const TT_S_US_AIR_2DAYAM    = "DM" // UPS Second Day Air A.M.
const TT_S_US_AIR_2DAY      = "DA" // UPS Second Day Air
const TT_S_US_3DAYSELECT    = "DS" // UPS Three-Day Select
const TT_S_US_GROUND        = "ND" // UPS Ground
